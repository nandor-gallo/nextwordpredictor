...
class Prediction:
    ...
    # Returns the predicted words list if any otherwise returns blank list
    ...
    # Returns the list of words from unique_words numpy array at the specified index location.
    ...
    # We input the sample as a feature vector. we convert the input string to a single feature vector        
    ...
    # Generates a bigram of the three predicted words with the previous word in the sentence.
    ...
    # Generates the bi-gram frequency from the corpus used for model training.
    ...
    # Generates frequency of each word in the corpus.
    ...
    # Creates a probability and maintains a table for each word combination.
    ...
    # gets the saved model from the .h5 file if it exists or calls the create_model method.
    ...
    # creates and trains the model by running 25 epochs.    
